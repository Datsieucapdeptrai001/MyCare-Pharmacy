...
public class MenuIcon implements Icon {
    ...
    public void paintIcon(Component c, Graphics g, int x, int y) {
        ...
        switch (type) {
            ...
            case "CALENDAR":
                g2d.drawRoundRect(x + 3, y + 4, 16, 15, 4, 4);
                g2d.drawLine(x + 3, y + 8, x + 19, y + 8);
                g2d.drawLine(x + 7, y + 2, x + 7, y + 6);
                g2d.drawLine(x + 15, y + 2, x + 15, y + 6);
                g2d.drawLine(x + 7, y + 12, x + 9, y + 12);
                g2d.drawLine(x + 12, y + 12, x + 14, y + 12);
                g2d.drawLine(x + 7, y + 15, x + 9, y + 15);
                g2d.drawLine(x + 12, y + 15, x + 14, y + 15);
                break;

            case "TIME":
                g2d.drawOval(x + 3, y + 3, 16, 16);
                g2d.drawLine(x + 11, y + 7, x + 11, y + 11);
                g2d.drawLine(x + 11, y + 11, x + 15, y + 13);
                g2d.fillOval(x + 10, y + 10, 2, 2);
                break;

            case "VIDEO":
                g2d.drawRoundRect(x + 3, y + 5, 16, 12, 4, 4);
                g2d.drawPolygon(
                        new int[]{x + 9, x + 9, x + 15},
                        new int[]{y + 8, y + 14, y + 11},
                        3
                );
                break;
            ...
            case "SETTING":
                ...
                g2d.drawLine(x + 11, y + 16, x + 11, y + 19);
                g2d.drawLine(x + 3, y + 11, x + 6, y + 11);
                g2d.drawLine(x + 16, y + 11, x + 19, y + 11);
                g2d.drawLine(x + 5, y + 5, x + 7, y + 7);
                g2d.drawLine(x + 15, y + 15, x + 17, y + 17);
                g2d.drawLine(x + 15, y + 7, x + 17, y + 5);
                g2d.drawLine(x + 5, y + 17, x + 7, y + 15);
                break;
        }
