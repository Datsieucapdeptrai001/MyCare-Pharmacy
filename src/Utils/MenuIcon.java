...
public class MenuIcon implements Icon {
    ...
    // --- Dùng trong màn hình Lô hàng / Kho ---
    public static final MenuIcon IC_REFRESH = new MenuIcon("REFRESH");
    public static final MenuIcon IC_HISTORY = new MenuIcon("LIST");
    public static final MenuIcon IC_KIEM_KE_KHO = new MenuIcon("KIEM_KE_KHO");
    public static final MenuIcon IC_XUAT_KHO = new MenuIcon("XUAT_KHO");
    public static final MenuIcon IC_NHAP_KHO = new MenuIcon("NHAP_KHO");
    public static final MenuIcon IC_HOTKEY = new MenuIcon("HOTKEY");
    ...
    public void paintIcon(Component c, Graphics g, int x, int y) {
        ...
        } else if (c != null && c.getForeground() != null && !c.getForeground().equals(Color.WHITE)) {
        ...
        switch (type) {
            ...
            case "HOME":
                g2d.drawPolygon(
                        new int[]{x + 11, x + 20, x + 2},
                        new int[]{y + 4, y + 12, y + 12},
                        3
                );
            ...
            case "TRASH":
                ...
                g2d.drawPolyline(
                        new int[]{x + 7, x + 8, x + 16, x + 17},
                        new int[]{y + 6, y + 19, y + 19, y + 6},
                        4
                );
            ...
            case "CORRECT":
                ...
                g2d.drawPolyline(
                        new int[]{x + 5, x + 10, x + 18},
                        new int[]{y + 12, y + 16, y + 6},
                        3
                );
                break;
            ...
            case "INVENTORY_CHECK":
                g2d.drawRoundRect(x + 5, y + 3, 12, 16, 3, 3);
                g2d.drawRoundRect(x + 8, y + 1, 6, 4, 2, 2);

                g2d.drawLine(x + 8, y + 8, x + 9, y + 9);
                g2d.drawLine(x + 9, y + 9, x + 12, y + 6);
                g2d.drawLine(x + 13, y + 8, x + 16, y + 8);

                g2d.drawLine(x + 8, y + 13, x + 9, y + 14);
                g2d.drawLine(x + 9, y + 14, x + 12, y + 11);
                g2d.drawLine(x + 13, y + 13, x + 16, y + 13);

                g2d.fillOval(x + 8, y + 16, 2, 2);
                g2d.drawLine(x + 13, y + 17, x + 16, y + 17);
                break;
            ...
            case "USERS":
                ...
                Color bg = c != null ? c.getBackground() : Color.WHITE;
                g2d.setColor(bg);
            ...
            case "LOGOUT":
                ...
                g2d.drawPolyline(
                        new int[]{x + 17, x + 20, x + 17},
                        new int[]{y + 8, y + 11, y + 14},
                        3
                );
                break;
            ...
            case "DOWNLOAD":
                ...
                g2d.drawPolyline(
                        new int[]{x + 6, x + 11, x + 16},
                        new int[]{y + 8, y + 13, y + 8},
                        3
                );
                g2d.drawPolyline(
                        new int[]{x + 4, x + 4, x + 18, x + 18},
                        new int[]{y + 14, y + 18, y + 18, y + 14},
                        4
                );
                break;
            ...
            case "SETTING_SLIDERS":
                ...
                g2d.drawOval(x + 13, y + 10, 4, 4);
                g2d.drawLine(x + 4, y + 18, x + 18, y + 18);
                g2d.drawOval(x + 8, y + 16, 4, 4);
                break;
            ...
            case "CHEVRON_LEFT":
                g2d.drawPolyline(
                        new int[]{x + 13, x + 8, x + 13},
                        new int[]{y + 6, y + 11, y + 16},
                        3
                );
                break;
            ...
            case "HOTKEY":
            case "KEYBOARD":
                g2d.drawRoundRect(x + 3, y + 6, 16, 11, 3, 3);
                g2d.setStroke(new BasicStroke(1.5f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND));
                g2d.drawRect(x + 6, y + 9, 2, 2);
                g2d.drawRect(x + 10, y + 9, 2, 2);
                g2d.drawRect(x + 14, y + 9, 2, 2);
                g2d.drawRect(x + 6, y + 13, 2, 2);
                g2d.drawRect(x + 10, y + 13, 6, 2);
                break;
            ...
            case "CHECK_OK":
                ...
                g2d.setStroke(new BasicStroke(2.5f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND));
                g2d.drawPolyline(
                        new int[]{x + 6, x + 10, x + 16},
                        new int[]{y + 11, y + 15, y + 7},
                        3
                );
                break;
            ...
            case "QR_SCANNER":
                int qrSize = Math.max(size - 16, 8);
                int qrX = x + 8;
                int qrY = y + 8;
                int corner = Math.max(qrSize / 4, 2);
                ...
                g2d.drawPolyline(
                        new int[]{qrX, qrX, qrX + corner},
                        new int[]{qrY + corner, qrY, qrY},
                        3
                );
                g2d.drawPolyline(
                        new int[]{qrX + qrSize - corner, qrX + qrSize, qrX + qrSize},
                        new int[]{qrY, qrY, qrY + corner},
                        3
                );
                g2d.drawPolyline(
                        new int[]{qrX, qrX, qrX + corner},
                        new int[]{qrY + qrSize - corner, qrY + qrSize, qrY + qrSize},
                        3
                );
                g2d.drawPolyline(
                        new int[]{qrX + qrSize - corner, qrX + qrSize, qrX + qrSize},
                        new int[]{qrY + qrSize, qrY + qrSize, qrY + qrSize - corner},
                        3
                );

                g2d.fillRect(qrX + (int) (qrSize * 0.2), qrY + (int) (qrSize * 0.2), Math.max((int) (qrSize * 0.2), 2), Math.max((int) (qrSize * 0.2), 2));
                g2d.fillRect(qrX + (int) (qrSize * 0.6), qrY + (int) (qrSize * 0.2), Math.max((int) (qrSize * 0.2), 2), Math.max((int) (qrSize * 0.2), 2));
                g2d.fillRect(qrX + (int) (qrSize * 0.2), qrY + (int) (qrSize * 0.6), Math.max((int) (qrSize * 0.2), 2), Math.max((int) (qrSize * 0.2), 2));
                g2d.fillRect(qrX + (int) (qrSize * 0.65), qrY + (int) (qrSize * 0.65), Math.max((int) (qrSize * 0.15), 2), Math.max((int) (qrSize * 0.15), 2));
            ...
            case "ARROW_RIGHT":
                ...
                g2d.drawLine(x + 12, y + 7, x + 16, y + 11);
                g2d.drawLine(x + 12, y + 15, x + 16, y + 11);
                break;

            case "ARROW_SUB":
                g2d.drawLine(x + 6, y + 4, x + 6, y + 14);
                g2d.drawLine(x + 6, y + 14, x + 16, y + 14);
                g2d.drawLine(x + 12, y + 10, x + 16, y + 14);
                g2d.drawLine(x + 12, y + 18, x + 16, y + 14);
                break;

            default:
                g2d.drawOval(x + 4, y + 4, 14, 14);
                g2d.drawLine(x + 8, y + 11, x + 14, y + 11);
                break;
        }
