    ...
    public boolean taoPhieuDoiTra(HoaDon hdDoiTra, List<Object[]> dsTra, List<Object[]> dsDoi) {
        ...
        if (dsTra != null) {
            for (Object[] spTra : dsTra) {
                ...
                daoCTHD.themChiTietDoiTra(hdDoiTra.getId(), tenSP, "Hộp", soLuong, 0.0, "TRA_LAI", true);
            }
        }
        ...
        if (dsDoi != null && !dsDoi.isEmpty()) {
            for (Object[] spDoi : dsDoi) {
                ...
                daoCTHD.themChiTietDoiTra(hdDoiTra.getId(), tenSP, "Hộp", soLuong, 0.0, "DOI_LAY", false);
            }
        }
