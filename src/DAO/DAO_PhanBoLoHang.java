...
public class DAO_PhanBoLoHang {
	public boolean themPhanBo(PhanBoLoHang pb) {
	    ...
	    String insertSql = "INSERT INTO PhanBoLoHang (hoaDonId, sanPhamId, donViDoLuongId, loHangId, soLuong) VALUES (?, ?, ?, ?, ?)";
	    
	    // Gói Connection vào Try to nhất để tự động giải phóng bộ nhớ
