...
-- ==============================================================================
-- PHẦN 1: TẠO MỚI DATABASE VÀ CÁC BẢNG
-- ==============================================================================
...
-- ==============================================================================
-- PHẦN 2: TẠO CẤU TRÚC BẢNG (TABLES)
-- ==============================================================================
...
-- *** BẢNG MỚI (thiếu trong SQLQuery3) ***
...
-- *** ĐÃ BỔ SUNG 2 CỘT dvdlYeuCau, dvdlTang (thiếu trong SQLQuery3) ***
...
-- ==============================================================================
-- PHẦN 3: THÊM RÀNG BUỘC CHECK (CHECK CONSTRAINTS)
-- ==============================================================================
...
-- ==============================================================================
-- PHẦN 4: CHÈN DỮ LIỆU (ĐÚNG THỨ TỰ CHA → CON)
-- ==============================================================================
...
-- B. KhachHang (diemTichLuy đã được cập nhật đúng từ ditmemaylnam)
...
-- D. CauHinhTichDiem (*** THIẾU TRONG SQLQuery3 ***)
INSERT [dbo].[CauHinhTichDiem] VALUES (10000, 1, 100, 100)
GO

-- E. KhuyenMai (*** THIẾU KM-2024-0011 → 0020 TRONG SQLQuery3 ***)
...
-- F. SanPham (SP2024-0001 → SP2024-0040)
...
-- H. DonViDoLuong (DVL-0001 → DVL-0068)
...
-- I. DieuKienKhuyenMai (*** THIẾU DK-0011 → DK-0020 TRONG SQLQuery3 ***)
...
-- J. HinhThucKhuyenMai (*** THIẾU HT-0011 → HT-0020 TRONG SQLQuery3 ***)
...
-- K. LoHang (trangThai đã được sửa đúng: LH-0005/0006/0014/0017 = HET_HAN)
...
INSERT [dbo].[LoHang] VALUES (N'LH-0005', N'LOT-2024-0005', N'SP2024-0005', 150,  CAST(80000.00  AS Decimal(18,2)), CAST(N'2025-12-31T00:00:00.0000000' AS DateTime2), N'HET_HAN',  CAST(N'2024-01-10T10:00:00.0000000' AS DateTime2), N'KHO-0001')
INSERT [dbo].[LoHang] VALUES (N'LH-0006', N'LOT-2024-0006', N'SP2024-0006', 100,  CAST(65000.00  AS Decimal(18,2)), CAST(N'2025-11-30T00:00:00.0000000' AS DateTime2), N'HET_HAN',  CAST(N'2024-01-10T10:00:00.0000000' AS DateTime2), N'KHO-0001')
...
INSERT [dbo].[LoHang] VALUES (N'LH-0014', N'LOT-2024-0014', N'SP2024-0014', 200,  CAST(28000.00  AS Decimal(18,2)), CAST(N'2026-04-30T00:00:00.0000000' AS DateTime2), N'HET_HAN',  CAST(N'2024-01-18T10:00:00.0000000' AS DateTime2), N'KHO-0002')
...
INSERT [dbo].[LoHang] VALUES (N'LH-0017', N'LOT-2024-0017', N'SP2024-0017', 200,  CAST(48000.00  AS Decimal(18,2)), CAST(N'2025-10-31T00:00:00.0000000' AS DateTime2), N'HET_HAN',  CAST(N'2024-01-22T09:00:00.0000000' AS DateTime2), N'KHO-0002')
...
-- N. ChiTietHoaDon
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0001', N'DVL-0008', N'SP2024-0004', 2)
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0001', N'DVL-0030', N'SP2024-0016', 1)
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0002', N'DVL-0039', N'SP2024-0021', 1)
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0002', N'DVL-0041', N'SP2024-0022', 1)
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0003', N'DVL-0016', N'SP2024-0009', 2)
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0003', N'DVL-0023', N'SP2024-0012', 1)
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0004', N'DVL-0002', N'SP2024-0001', 1)
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0004', N'DVL-0028', N'SP2024-0015', 1)
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0005', N'DVL-0052', N'SP2024-0028', 1)
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0005', N'DVL-0053', N'SP2024-0029', 1)
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0006', N'DVL-0025', N'SP2024-0013', 1)
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0006', N'DVL-0033', N'SP2024-0018', 1)
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0007', N'DVL-0043', N'SP2024-0023', 2)
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0007', N'DVL-0047', N'SP2024-0025', 1)
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0008', N'DVL-0021', N'SP2024-0011', 1)
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0008', N'DVL-0044', N'SP2024-0024', 5)
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0009', N'DVL-0030', N'SP2024-0016', 2)
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0009', N'DVL-0031', N'SP2024-0017', 1)
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0010', N'DVL-0006', N'SP2024-0003', 1)
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0010', N'DVL-0008', N'SP2024-0004', 1)
INSERT [dbo].[ChiTietHoaDon] VALUES (N'HD2024-0010', N'DVL-0019', N'SP2024-0010', 1)
GO
...
-- ==============================================================================
-- PHẦN 5: TẠO KHÓA NGOẠI (FOREIGN KEYS)
-- ==============================================================================
...
-- ==============================================================================
-- PHẦN 6: CẬP NHẬT giaBan THEO ĐƠN VỊ CƠ BẢN
-- ==============================================================================
